...
public class HolidayVIIIDutyFree {
    public static void main(String[] args) {
        System.out.println(dutyFree(275, 7, 500));
    }

    public static int dutyFree(int normPrice, int discount, int hol) {
        double result;
        double priceWithDiscount = normPrice - normPrice * ((double)discount / 100);
        double delta = (double)normPrice - priceWithDiscount;
        result = (double)hol/delta;
        return (int) result;
    }
}
